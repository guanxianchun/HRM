package com.sailing.hrm.web.platform;
...
public class PlatformContoller {
	...
	@RequestMapping(value = "/workflow_index" ,method=RequestMethod.GET)
	public String workflowMain(Model model) {
		return "system/workflow_index";
	}
}
