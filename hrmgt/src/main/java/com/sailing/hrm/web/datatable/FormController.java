...
package com.sailing.hrm.web.datatable;
...
import com.sailing.hrm.common.util.HtmlParserUtil;
import com.sailing.hrm.persistent.common.Page;
import com.sailing.hrm.persistent.common.PropertyFilter;
import com.sailing.hrm.persistent.form.bean.DbTable;
import com.sailing.hrm.persistent.form.bean.Form;
import com.sailing.hrm.service.datatable.DbTableManager;
import com.sailing.hrm.service.datatable.FormManager;
import com.sailing.hrm.web.util.PropertyFilterUtil;
...
public class FormController {
    ...
    @Autowired
    private HtmlParserUtil htmlProcessor;
    ...
    public String list(Model model, Page<Form> page, HttpServletRequest request) {
        List<PropertyFilter> filters = PropertyFilterUtil.buildFromHttpRequest(request);
        //设置默认排序方式
