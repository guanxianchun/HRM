package com.sailing.hrm.web.report;
...
import com.sailing.hrm.service.report.BirtEngine;
 ...
 */
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		logger.log(Level.FINE, "image directory " + sc.getRealPath("/images_birt"));
		...
		try {
			// Open report design
			design = birtReportEngine.openReportDesign(sc.getRealPath("/reportDS") + "/" + reportName);
