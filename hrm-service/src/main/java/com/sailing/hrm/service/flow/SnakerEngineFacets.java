 ...
 */
package com.sailing.hrm.service.flow;
...
public class SnakerEngineFacets {
	...
	public SnakerEngineFacets() {
		engine = new SnakerEngineImpl();
	}
	
	public void initFlows() {
		engine.process().deploy(StreamHelper.getStreamFromClasspath("workflows/actorall.snaker"));
		engine.process().deploy(StreamHelper.getStreamFromClasspath("workflows/group.snaker"));
		engine.process().deploy(StreamHelper.getStreamFromClasspath("workflows/leave.snaker"));
		engine.process().deploy(StreamHelper.getStreamFromClasspath("workflows/forkjoin.snaker"));
		engine.process().deploy(StreamHelper.getStreamFromClasspath("workflows/custom.snaker"));
		engine.process().deploy(StreamHelper.getStreamFromClasspath("workflows/free.snaker"));
	}
