...
import com.sailing.hrm.common.constant.Const;
...
public class StringUtil {
	...
	public static String checkFolder(String folderPath) {
		if (!folderPath.endsWith(Const.SEPARATOR_LINUX)
				&& !folderPath.endsWith(Const.SEPARATOR_WINDOW)) {
			folderPath += Const.SEPARATOR_LINUX;
		}
		return folderPath;
	}
	...
	public static String formatSeparator(String fileName) {
		fileName = fileName.replace(Const.SEPARATOR_WINDOW,
