package com.sailing.hrm.persistent.menu.bean;

import com.sailing.hrm.persistent.page.PageInfo;
...
public class MenuTreeNode extends PageInfo {
	...
	public MenuTreeNode(String text, String src, String action, String icon, String open_icon, String target,
			String data, MenuTreeNode parent) {
		this.title = text;
		this.src = src;
		this.action = action;
		this.icon = icon;
