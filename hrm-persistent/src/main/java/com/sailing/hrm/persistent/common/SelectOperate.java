package com.sailing.hrm.persistent.common;
...
public class SelectOperate {
	...
	public String getDeviceTypeExcel(String excelValue, String type) throws Exception {
		List depts = new ArrayList();
		String sql = "SELECT z.sbxl_id,z.sbxl_name FROM dw_dim_gddw_zysblx z where  z.type<>'N' and  z.type like'%"
				+ type + "%' order by sbxl_id ";
		List keys = new ArrayList<String>();
		List values = new ArrayList<String>();
		String value = "0";
		if (excelValue != null && !"".equals(excelValue)) {
	...
	public String getDeviceTypeChina(String sbxl_id, String type) {
		String sql = "SELECT z.sbxl_name FROM dw_dim_gddw_zysblx z where sbxl_id=" + sbxl_id
				+ " and  z.type<>'N' and  z.type like'%" + type + "%' order by sbxl_id ";
		String value = "0";
		try {
			ResultSet rs = geneDao.executeQuery(sql, null);
			if (rs.next()) {
